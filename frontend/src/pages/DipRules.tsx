  ...
  return (
    <div className="main">
          ...
          {pendingEvents.map((e) => (
            <div key={e.id} style={{ marginBottom: 12, paddingBottom: 12, borderBottom: "1px solid #23262b" }}>
              ...
              <div style={{ marginTop: 8, display: "flex", gap: 8 }}>
                <button onClick={() => resolve(e.id, "CONFIRM")}>Confirm investment</button>
                <button className="secondary" onClick={() => resolve(e.id, "SKIP")}>Skip</button>
                <button className="secondary" onClick={() => resolve(e.id, "DEFER")}>Defer</button>
              </div>
            </div>
          ))}
        </div>
      ...
      <div className="card">
        ...
        <button style={{ marginTop: 8 }} onClick={save}>Save thresholds</button>
      </div>
      ...
      <div className="card">
        ...
        <div style={{ display: "flex", gap: 8 }}>
          ...
          <button onClick={runSimulation}>Evaluate</button>
        </div>
        {simResult && (
